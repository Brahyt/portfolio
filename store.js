const tinkeringStuff = [
  {
    title: 'Chomply',
    liveLink: 'https://www.chomply.net',
    githubLink: 'https://github.com/Brahyt/chomply-client',
  ...
  },
  {
    ...
    desc:
      'A 5 person group project Mobile app, built in React, Node/Express, and Postgresql, leveraging Maps and GeoData services from Google. Live List is an app to find new things to do based on your location and likes.',
    preview: 'images/ll.png',
    alt:
      'mobile design for website that contains a list of places with choices for ramen.',
  },
  {
    title: 'weyr alliance',
    ...
    desc:
      'charactor/party managment for dragonfire game. built in react, express.js, node.js, and sql. ',
    preview: 'images/weyr.png',
    alt:
      'screenshot of the a bookmarking app that i made in jquery and javascript.',
  },
  {
    title: 'Quendi - Spaced Repetition',
    liveLink: 'https://www.quendi.app',
    githubLink:
      'https://github.com/thinkful-ei-heron/Spaced-Rep-Andrea-DanB-Client',
    githubLink2:
      'https://github.com/thinkful-ei-heron/Spaced-Rep-Andrea-DanB-Server',
    desc:
      'Full stack Javascript web app built in React, Express and Node utilizing Linked List data structure and a SQL database. Built with a collaboration with another person.',
  ...
  //  },
  {
    ...
    desc:
      'Webapp built on Ruby on Rails. Used for a culinary apprenticeship program to attract new mentors and apprentices. ',
